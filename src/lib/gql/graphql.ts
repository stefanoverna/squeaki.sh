...
export type BlogPostFragmentFragment = { __typename?: 'BlogPostRecord', id: string, slug: string, title: string, _firstPublishedAt: string, content: { __typename?: 'BlogPostModelContentField', value: unknown, blocks: Array<(
      { __typename?: 'ImageRecord' }
