/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9dd0588bd601c885f7a080af839f0782)
// Runtime types generated with workerd@1.20260310.1 2025-01-10 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    NEWS_KV: KVNamespace;
    ASSETS: Fetcher;
    PRIVATE_DATOCMS_BUILD_TRIGGER_WEBHOOK: '';
    PRIVATE_DATOCMS_READONLY_API_TOKEN: string;
    PRIVATE_DATOCMS_READWRITE_API_TOKEN: string;
    PRIVATE_POSTMARK_WEBHOOK_API_TOKEN: string;
    PRIVATE_NEWSLETTER_SEND_API_TOKEN: string;
    PRIVATE_POSTMARK_SERVER_TOKEN: string;
    PRIVATE_TURNSTILE_SECRET_KEY: string;
    PRIVATE_NEWS_TOKEN: string;
  }
}
