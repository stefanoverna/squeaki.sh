      ...
      <head>
        ...
        <style type="text/css">
          * { box-sizing: border-box; }
          img { max-width: 100%; }
          body { --gap: 2vw; margin: 0; font-family: system-ui; line-height: 1.7; }
        ...
        <nav class="intro">
          <div class="container">
            <div>
              ...
              <small>
                Have no idea what RSS feeds are? Visit <a href="https://aboutfeeds.com">About Feeds</a> to get started with newsreaders and subscribing.
              </small>
            </div>
            <!-- via https://www.newgrounds.com/art/view/wheatly811/yahaha-you-found-me -->
            <img src="/yahaha-you-found-me.gif" alt="A dancing Korok from Zelda: Breath of the Wild" />
          </div>
        </nav>
        <div class="container">
          <header>
